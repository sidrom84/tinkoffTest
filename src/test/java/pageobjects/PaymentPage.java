...
public class PaymentPage extends Main{
    ...
    public void setRegion(String regionToSetName, String regionToCheckName) {
        //устанавливаем Регион и проверяем результат
        // regionToSetName - Регион, который будем устанавливать
        // regionToCheckName - Регион, который будем проверять, отличается падежное окончание
    ...
    public void checkFirstProvider(String firstProviderName) {
        ...
        // firstProviderName - наименование Поставщика услуг, который должен быть первым в списке
    ...
    public void navigateToZhkhPage(String zhkhName) {
        ...
        // zhkhName - наименование Поставщика услуг, к которому идти
    ...
    public void searchZhkh(String request, Boolean pressEnter, Boolean checkPresence, Boolean click) {
        ...
        // request - наименование Поставщика услуг, которого ищем
        // pressEnter - нажимать кнопку ENTER или нет, оказалось не очень нужно
        // checkPresence - проверять отображение выпадающего списка и наличие наименования Поставщика услуг
        // click - кликать по наименованию Поставщика услуг
    ...
    public boolean elementIsNotPresent(String text) {
        ...
        // text - текст, которого не должно быть
